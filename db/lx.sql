...
CREATE TABLE `msg` (
  ...
  `bang_num` int(11) NOT NULL DEFAULT '0',
  ...
  `image5` varchar(60) DEFAULT NULL,
  `image6` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `msg_s_index` (`bang_num`),
  KEY `msg_r_index` (`share_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
--  Table structure for `msg_bang`
-- ----------------------------
DROP TABLE IF EXISTS `msg_bang`;
CREATE TABLE `msg_bang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ct` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
-- ----------------------------
--  Table structure for `msg_collect`
-- ----------------------------
DROP TABLE IF EXISTS `msg_collect`;
CREATE TABLE `msg_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ct` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `msg_id` int(11) NOT NULL,
...
CREATE TABLE `msg_comment` (
  ...
  `user_id` int(11) NOT NULL,
  `msg_id` int(11) NOT NULL,
  `op_user_id` int(11) NOT NULL DEFAULT '0',
  `content` varchar(60) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
--  Table structure for `msg_share`
-- ----------------------------
DROP TABLE IF EXISTS `msg_share`;
CREATE TABLE `msg_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ct` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `msg_id` int(11) NOT NULL,
...
CREATE TABLE `user_relation` (
  ...
  `is_op_friend` tinyint(4) NOT NULL,
  `is_enemy` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
